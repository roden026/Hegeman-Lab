...
to pull out the numbers of Hydrogens, Carbons, Oxygens, and Nitrogens.
'''
...
# which is what is needed for VanKrevelen Analysis. Also works for up to 3 digits (ie H999).
                            ...
                            if location + 3 < len(compound):
                                if compound[location + 2].isdigit() and compound[location + 3].isdigit():
                                    ...
                                    if compound[location + 2].isdigit():
                                        ...
                                        line_elementCounts.append(float(compound[location + 1: location + 2]))
                                        break
                                else:
                                    line_elementCounts.append(float(compound[location + 1: location + 2]))
                                    break
